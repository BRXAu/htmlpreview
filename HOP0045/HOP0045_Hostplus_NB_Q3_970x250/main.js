...
function startAnimation() {
  ...
  //----Frame1------//
  // In
  disappear("copy1-cont", time, { width: "+=600", ease: Sine.easeOut }, "f1", false);
  appear("terms", time, { opacity: 0, y: "+=10", ease: Quint.easeOut}, "f1");

  appear("copy3", time, { opacity: 0, y: "-=90", ease: Quint.easeOut }, "f1+=.5");
  appear("copy4-cont", time, { opacity: 0, y: "-=10", ease: Quint.easeOut }, "f1+=1");
  appear("copy4-1", time, { opacity: 0, ease: Quint.easeOut }, "f1+=1");
  //appear("cta-cont", time/2, { opacity: 0, y:"-=5", ease: Sine.easeOut }, "f1+=1.5");
  ...
  disappear("copy4-cont",time,{opacity:0,ease:Quint.easeOut},"f1Out+=1.5");
