...
function startAnimation() {
  ...
  //----Frame1------//
  // In
  disappear("copy1-1-cont", time, { width: "+=309", ease: Sine.easeOut }, "f1", false);
  disappear("copy1-2-cont", time, { width: "+=309", ease: Sine.easeOut }, "f1", false);
  appear("terms", time, { opacity: 0, y: "+=10", ease: Quint.easeOut}, "f1");

  appear("copy2", time, { opacity: 0, y: "-=82", ease: Quint.easeOut }, "f1+=.5");
  appear("copy3-1", time, { opacity:0, y: "-=30", ease: Quint.easeOut }, "f1+=1");
  ...
  disappear("copy1-1-cont",time,{opacity:0,ease:Quint.easeOut},"f1Out+=1.5", false);
  disappear("copy1-2-cont",time,{opacity:0,ease:Quint.easeOut},"f1Out+=1.5", false);
  disappear("copy2",time,{opacity:0,ease:Quint.easeOut},"f1Out+=1.5");
  disappear("copy3-1",time,{opacity:0,ease:Quint.easeOut},"f1Out+=1.5");
