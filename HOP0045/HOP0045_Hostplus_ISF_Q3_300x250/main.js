...
function startAnimation() {
  ...
  //----Frame1------//
  // In
  disappear("copy1-cont", time, { width: "+=255", ease: Sine.easeOut }, "f1", false);
  appear("terms", time, { opacity: 0, y: "+=10", ease: Quint.easeOut}, "f1");

  appear("copy2", time, { opacity: 0, y: "-=82", ease: Quint.easeOut }, "f1+=.5");
  appear("copy3", time, { opacity: 0, y: "-=82", ease: Quint.easeOut }, "f1+=1");
  appear("copy4-1", time, { opacity: 0, y: "-=30", ease: Quint.easeOut }, "f1+=1.5");
