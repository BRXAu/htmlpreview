...
function startAnimation() {
  ...
  // appear("copy1-2-1", .25, { opacity: 0, y: "-70", ease: "back.out(2.7)" }, "f1+=.5");
  // appear("copy1-2-2", .25, { opacity: 0, y: "-70", ease: "back.out(2.7)", onComplete: shake2 }, "f1+=.5");

  appear("copy1-1-1", .25, { opacity: 0, y: "-80", ease: "back.out(2.5)" }, "f1+=.5");
  appear("copy1-1-2", .25, { opacity: 0, y: "-80", ease: "back.out(2.5)" }, "f1+=.5");
  appear("copy1-1-3", .25, { opacity: 0, y: "-80", ease: "back.out(2.5)" }, "f1+=.5");

  disappear("crack-1-cont1", .5, { height:45, ease: Quad.easeOut}, "f1+=.8", false);
  disappear("crack-1-cont2", .5, { height:45, ease: Quad.easeOut }, "f1+=.8", false);
  disappear("crack-1-cont3", .5, { height:45, ease: Quad.easeOut }, "f1+=.8", false);
  // disappear("crack-2-cont1", .5, { height:60, ease: Quad.easeOut }, "f1+=1.35", false);
  // disappear("crack-2-cont2", .5, { height:60, ease: Quad.easeOut }, "f1+=1.35", false);
  disappear("crack-3-cont1", .55, { height:32.5, ease: Quad.easeOut }, "f1+=1.15", false);
  disappear("crack-3-cont2", .55, { height:32.5, ease: Quad.easeOut }, "f1+=1.15", false);


  disappear("copy1-3-1-cont", 1.25, {  rotationZ: 30, ease: Cubic.easeInOut }, "f1Out+=.5", false);
  disappear("copy1-3-1-cont", 1.25, {  y:"+=315", ease: Quad.easeInOut }, "f1Out+=.55", false);
  disappear("copy1-3-2-cont", 1.25, {  rotationZ: -30, ease: Cubic.easeInOut }, "f1Out+=.5");
  disappear("copy1-3-2-cont", 1.25, {  y:"+=315", ease: Quad.easeInOut }, "f1Out+=.55")

  // disappear("copy1-2-1-cont", 1.5, {  rotationZ: 40, x:"-=40", ease: Cubic.easeInOut }, "f1Out+=.6");
  // disappear("copy1-2-1-cont", 1.25, {  y:"+=315", ease: Quad.easeInOut }, "f1Out+=.65", false);
  // disappear("copy1-2-2-cont", 1.5, {  rotationZ: -45, x:"+=40", ease: Cubic.easeInOut }, "f1Out+=.65");
  // disappear("copy1-2-2-cont", 1.25, {  y:"+=315", ease: Quad.easeInOut }, "f1Out+=.7", false)

  disappear("copy1-1-1-cont", 1.25, {  y:"+=315", ease: Quad.easeInOut }, "f1Out+=.75");
  disappear("copy1-1-1-cont", 1.25, {  rotationZ: 25, x:"-=40",  ease: Cubic.easeInOut }, "f1Out+=.8");
  disappear("copy1-1-2-cont", 1.25, {  y:"+=315", ease: Quad.easeInOut }, "f1Out+=.75");
  disappear("copy1-1-2-cont", 1.25, {  rotationZ: -35, x:"+=30", ease: Cubic.easeInOut }, "f1Out+=.75");
  disappear("copy1-1-3-cont", 1.25, {  y:"+=315", ease: Quad.easeInOut }, "f1Out+=.8");
  ...
  disappear("copy2-1", .8, { y: "-=53", ease: Quint.easeOut }, "f2Out+=.5", false);
  disappear("copy2-2-cont", .8, { y: "-=53", ease: Quint.easeOut }, "f2Out+=.5", false);
...
function onMouseOver() {
  ...
  //TweenLite.to("#copy4-1", 0.05, { opacity: 0, ease: Power2.easeOut });
...
function onMouseOut() {
  ...
  //TweenLite.to("#copy4-1", 0.05, { opacity: 1, ease: Power2.easeOut });
