...
function startAnimation() {
  ...
  appear("copy1-1-1", .25, { opacity: 0, y: "-80", ease: "back.out(1.5)" }, "f1+=.5");
  appear("copy1-1-2", .25, { opacity: 0, y: "-80", ease: "back.out(1.5)" }, "f1+=.5");
  appear("copy1-1-3", .25, { opacity: 0, y: "-80", ease: "back.out(1.5)" }, "f1+=.5");
  ...
  disappear("crack-1-cont3", .5, { height:25, ease: Quad.easeOut }, "f1+=.8", false);
  ...
  disappear("copy2-1", .8, { y: "-=35", ease: Quint.easeOut }, "f2Out+=.5", false);
  disappear("copy2-2-cont", .8, { y: "-=38", ease: Quint.easeOut }, "f2Out+=.5", false);
