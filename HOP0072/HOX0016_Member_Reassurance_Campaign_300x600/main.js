...
function startAnimation() {
  ...
  // appear("copy1-2-1", .25, { opacity: 0, y: "-70", ease: "back.out(2.9)" }, "f1+=.5");
  // appear("copy1-2-2", .25, { opacity: 0, y: "-70", ease: "back.out(2.9)", onComplete: shake2 }, "f1+=.5");

  appear("copy1-1-1", .25, { opacity: 0, y: "-80", ease: "back.out(2.6)" }, "f1+=.5");
  appear("copy1-1-2", .25, { opacity: 0, y: "-80", ease: "back.out(2.6)" }, "f1+=.5");
  appear("copy1-1-3", .25, { opacity: 0, y: "-80", ease: "back.out(2.6)" }, "f1+=.5");



  disappear("crack-1-cont1", .5, { height:30, ease: Quad.easeOut}, "f1+=.8", false);
  disappear("crack-1-cont2", .5, { height:30, ease: Quad.easeOut }, "f1+=.8", false);
  disappear("crack-1-cont3", .5, { height:42, ease: Quad.easeOut }, "f1+=.8", false);
  // disappear("crack-2-cont1", .5, { height:53, ease: Quad.easeOut }, "f1+=1.35", false);
  // disappear("crack-2-cont2", .5, { height:50, ease: Quad.easeOut }, "f1+=1.35", false);
  disappear("crack-3-cont1", .55, { height:33, ease: Quad.easeOut }, "f1+=1.15", false);
  disappear("crack-3-cont2", .55, { height:25, ease: Quad.easeOut }, "f1+=1.15", false);
  ...
  // disappear("copy1-2-2-cont", 1.5, {  y:"+=500", x:"+=90", ease: Cubic.easeInOut }, "f1Out+=.85", false)
  // disappear("copy1-2-1-cont", 1.65, {  rotationZ: 40, transformOrigin: "50% 50%", ease: Cubic.easeInOut }, "f1Out+=.95");
  // disappear("copy1-2-1-cont", 1.5, {  y:"+=500", x:"-=90", ease: Cubic.easeInOut }, "f1Out+=1", false);

  disappear("copy1-1-1-cont", 1.5, {  rotationZ: 25, x:"-=110", transformOrigin: "50% 50%", ease: Cubic.easeInOut }, "f1Out+=1.4");
  disappear("copy1-1-1-cont", 1.5, {  y:"+=550", ease: Quad.easeInOut }, "f1Out+=1.45");
  disappear("copy1-1-2-cont", 1.5, {  rotationZ: -35, x:"+=80", ease: Cubic.easeInOut }, "f1Out+=1.25");
  disappear("copy1-1-2-cont", 1.5, {  y:"+=550", ease: Quad.easeInOut }, "f1Out+=1.3");
  disappear("copy1-1-3-cont", 1.5, {  rotationZ: -30, x:"+=110", transformOrigin: "50% 50%", ease: Cubic.easeInOut }, "f1Out+=1.1");
  ...
  disappear("copy2-1", .8, { y: "-=72", ease: Quint.easeOut }, "f2Out+=.5", false);
  disappear("copy2-2-cont", .8, { y: "-=72", ease: Quint.easeOut }, "f2Out+=.5", false);
