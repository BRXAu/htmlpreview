...
function startAnimation() {
  ...
  // appear("copy1-2-1", .25, { opacity: 0, y: "-110", ease: "back.out(1.9)" }, "f1+=.5");
  // appear("copy1-2-2", .25, { opacity: 0, y: "-110", ease: "back.out(1.9)", onComplete: shake2 }, "f1+=.5");

  appear("copy1-1-1", .25, { opacity: 0, y: "-170", ease: "back.out(1.5)" }, "f1+=.5");
  appear("copy1-1-2", .25, { opacity: 0, y: "-170", ease: "back.out(1.5)" }, "f1+=.5");
  appear("copy1-1-3", .25, { opacity: 0, y: "-170", ease: "back.out(1.5)" }, "f1+=.5");


  disappear("crack-1-cont1", .5, { height:25, ease: Quad.easeOut}, "f1+=.8", false);
  disappear("crack-1-cont2", .5, { height:25, ease: Quad.easeOut }, "f1+=.8", false);
  disappear("crack-1-cont3", .5, { height:29, ease: Quad.easeOut }, "f1+=.8", false);
  // disappear("crack-2-cont1", .5, { height:34, ease: Quad.easeOut }, "f1+=1.35", false);
  // disappear("crack-2-cont2", .5, { height:34, ease: Quad.easeOut }, "f1+=1.35", false);
  disappear("crack-3-cont1", .55, { height:20, ease: Quad.easeOut }, "f1+=1.15", false);
  disappear("crack-3-cont2", .55, { height:20, ease: Quad.easeOut }, "f1+=1.15", false);

  disappear("copy1-3-2-cont", 1.5, {  rotationZ: -30, x:"-=10", ease: Cubic.easeInOut }, "f1Out+=.5");
  disappear("copy1-3-2-cont", 1.5, {  y:"+=500", ease: Cubic.easeInOut }, "f1Out+=.55")
  disappear("copy1-3-1-cont", 1.5, {  rotationZ: 30, x:"+=10", ease: Cubic.easeInOut }, "f1Out+=.65", false);
  disappear("copy1-3-1-cont", 1.5, {  y:"+=500", ease: Cubic.easeInOut }, "f1Out+=.7", false);

  // disappear("copy1-2-2-cont", 1.65, {  rotationZ: -45, transformOrigin: "50% 50%", ease: Cubic.easeInOut }, "f1Out+=.8");
  // disappear("copy1-2-2-cont", 1.5, {  y:"+=500", x:"+=60", ease: Cubic.easeInOut }, "f1Out+=.85", false)
  // disappear("copy1-2-1-cont", 1.65, {  rotationZ: 40, transformOrigin: "50% 50%", ease: Cubic.easeInOut }, "f1Out+=.95");
  // disappear("copy1-2-1-cont", 1.5, {  y:"+=500", x:"-=60", ease: Cubic.easeInOut }, "f1Out+=1", false);

  disappear("copy1-1-1-cont", 1.5, {  rotationZ: 25, x:"-=60", transformOrigin: "50% 50%", ease: Cubic.easeInOut }, "f1Out+=1.4");
  disappear("copy1-1-1-cont", 1.5, {  y:"+=550", ease: Quad.easeInOut }, "f1Out+=1.45");
  disappear("copy1-1-2-cont", 1.5, {  rotationZ: -35, x:"+=50", ease: Cubic.easeInOut }, "f1Out+=1.25");
  disappear("copy1-1-2-cont", 1.5, {  y:"+=550", ease: Quad.easeInOut }, "f1Out+=1.3");
  disappear("copy1-1-3-cont", 1.5, {  rotationZ: -30, x:"+=60", transformOrigin: "50% 50%", ease: Cubic.easeInOut }, "f1Out+=1.1");
  disappear("copy1-1-3-cont", 1.5, {  y:"+=550", ease: Quad.easeInOut }, "f1Out+=1.15");


  appear("copy2-1", time, { opacity: 0, y: "-=10", ease: Quint.easeOut }, "f2+=.5");
  appear("copy2-2", time, { opacity: 0, y: "-=50", ease: Quint.easeOut }, "f2+=.75");

  disappear("copy2-1", .8, { y: "-=66", ease: Quint.easeOut }, "f2Out+=.5", false);
  disappear("copy2-2-cont", .8, { y: "-=66", ease: Quint.easeOut }, "f2Out+=.5", false);

  //appear("copy4-2", time, { opacity: 0, y: "-=30", ease: Quint.easeOut }, "f3-=.5");
  appear("copy4-1-2", time, { opacity: 0, y: "-=36", ease: Quint.easeOut }, "f3-=.5");
