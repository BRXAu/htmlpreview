...
function allDocIsReady() {
	...
	theTimeline.add(new TweenLite.to('#copy1_f1_mask, #copy2_f1_mask, #f1', 0.5, {opacity:0}), "+=0.3")

	//Frame 3
	theTimeline.add(new TweenLite.from('#copy1_f2_mask', 0.5, {width:'0px', ease:Power2.easeOut, onStart:rollInAwards}));
