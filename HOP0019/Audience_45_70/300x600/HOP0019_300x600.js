...
function allDocIsReady() {
	...
	theTimeline.add(new TweenLite.from('#copy4', 0.5, {y:-87, ease:Power2.easeOut, onComplete:clockAlarm}));
	...
	theTimeline.add(new TweenLite.from('#copy6', 0.5, {y:-86, ease:Power2.easeOut}));
