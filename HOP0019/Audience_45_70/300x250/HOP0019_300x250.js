...
function allDocIsReady() {
	...
	theTimeline.add(new TweenMax.to("#clock", 0.08, {rotation:-10}));
	theTimeline.add(new TweenMax.to("#clock", 0.08, {rotation:10}));
	theTimeline.add(new TweenMax.to("#clock", 0.08, {rotation:-10}));
	theTimeline.add(new TweenMax.to("#clock", 0.08, {rotation:10}));
	theTimeline.add(new TweenMax.to("#clock", 0.08, {rotation:-10}));
	theTimeline.add(new TweenMax.to("#clock", 0.08, {rotation:10}));
	theTimeline.add(new TweenMax.to("#clock", 0.08, {rotation:0}));
	// theTimeline.add(new TweenMax.to("#clock", 0.15, {rotation:10}));			

	theTimeline.add(new TweenLite.to('#copy3_mask, #copy4_mask, #clock', 0.5, {opacity:0}), "+=1.8");
