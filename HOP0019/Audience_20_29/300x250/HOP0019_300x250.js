...
function allDocIsReady() {
	...
	// theTimeline.add(new TweenLite.to('#f1_clap', 0.15, {scaleY:1}))		

	theTimeline.add(new TweenLite.to('#copy3_mask, #copy4_mask, #f1_lefthand, #f1_righthand, #f1_clap', 0.5, {opacity:0}), "+=2");
