...
function allDocIsReady() {
	...
	theTimeline.add(new TweenLite.from('#copy2', 0.5, {y:-55, ease:Power2.easeOut}));
	...
	theTimeline.add(new TweenLite.to("#laptopHead", 0.45, {width:"71px", height:"46px", clipPath:"polygon(0 0%, 100% 0%, 100% 100%, 0% 100%)", ease:Linear.easeNone}))
	...
	{width:"63px", height:"38px", y:0, clipPath:"polygon(0 0%, 100% 0%, 100% 100%, 0% 100%)", ease:Linear.easeNone}), "-=0.45")	
