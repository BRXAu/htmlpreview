...
function allDocIsReady() {
	...
	theTimeline.add(new TweenLite.to('#copy1_mask, #copy2_mask, #f1_head_group', 0.5, {opacity:0}), "+=2");
	...
	theTimeline.add(new TweenLite.from('#copy6', 0.5, {y:-80, ease:Power2.easeOut}));

	theTimeline.add(new TweenLite.from("#f3_head_group", 0.5, {opacity:0}), "-=1.1");

	theTimeline.add(new TweenLite.fromTo("#f3_mic", 0.5, {y:0}, {y:-4, ease:Power2.easeInOut}));
	...
	theTimeline.add(new TweenLite.to("#f3_head_1, #f3_mic", 0.5, {rotation:10, ease:Power2.easeInOut}));
	theTimeline.add(new TweenLite.to("#f3_head_1, #f3_mic", 0.5, {y:5, ease:Power2.easeInOut}));
	theTimeline.add(new TweenLite.to("#f3_head_1, #f3_mic", 0.5, {y:0, ease:Power2.easeInOut}));			
	theTimeline.add(new TweenLite.to("#f3_head_1, #f3_mic", 0.5, {rotation:0, ease:Power2.easeInOut}));		

	theTimeline.add(new TweenMax.to('#copy5_mask, #copy6_mask, #f3_head_group', 0.5, {opacity:0}));
