...
function allDocIsReady() {
	...
	theTimeline.add(new TweenLite.from('#copy4', 0.5, {y:-81, ease:Power2.easeOut}));
	...
	handTimeline.add(new TweenLite.to('#dollarSign', 0.15, {rotation:-26, x:6, y:-50, scale:1.20, ease:Linear.easeNone}));
	handTimeline.add(new TweenLite.to('#hand', 0.5, {rotation:0, x:0, y:0, ease:Back.easeIn.config(5)}));
	handTimeline.add(new TweenLite.to('#dollarSign', 0.5, {rotation:0, x:8, y:10, ease:Back.easeIn.config(5)}), "-=0.5");	
	...
	theTimeline.add(new TweenLite.to("#laptopHead", 0.45, {width:"119px", height:"77px", clipPath:"polygon(0 0%, 100% 0%, 100% 100%, 0% 100%)", ease:Linear.easeNone}))
	theTimeline.add(new TweenLite.fromTo("#laptopScreen", 0.45, {
		width:"107px", height:"41px", y:29, clipPath:"polygon(0px 93.338%, 100% 93.338%, 98.0141% 100%, 3.9718% 100%)"
	}, 
	{width:"104px", height:"64px", y:0, clipPath:"polygon(0 0%, 100% 0%, 100% 100%, 0% 100%)", ease:Linear.easeNone}), "-=0.45")	
