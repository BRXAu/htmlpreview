...
function allDocIsReady() {
	...
	handTimeline.add(new TweenLite.to('#hand, #dollarSign', 0.5, {rotation:-5, y:-4, transformOrigin:"bottom right", ease:Back.easeIn.config(20)}), "+=2.9")
	handTimeline.add(new TweenLite.to('#hand, #dollarSign', 0.15, {rotation:-15, y:-15, transformOrigin:"100% 100%", ease:Linear.easeNone}));
	handTimeline.add(new TweenLite.to('#dollarSign', 0.15, {rotation:-26, x:6, y:-26, scale:1.20, ease:Linear.easeNone}));
	handTimeline.add(new TweenLite.to('#hand', 0.5, {rotation:0, x:0, y:0, ease:Back.easeIn.config(5)}));
	handTimeline.add(new TweenLite.to('#dollarSign', 0.5, {rotation:0, x:5, y:4, ease:Back.easeIn.config(5)}), "-=0.5");	
